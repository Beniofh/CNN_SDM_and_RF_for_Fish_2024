...
def main(config_name: str) -> None:
    @hydra.main(version_base="1.1", config_path="config", config_name=config_name)
    def sub_main(cfg: DictConfig) -> None:
...
if __name__ == "__main__":
    config_names = ["cnn_sdm_abundance_without_tl_0.yaml",]
    for config_name in config_names:
        main(config_name)

'''
"cnn_multi_band_config_agg_trans_0.yaml","cnn_multi_band_config_agg_trans_0.yaml",
"cnn_multi_band_config_agg_trans_1.yaml","cnn_multi_band_config_agg_trans_1.yaml",
"cnn_multi_band_config_agg_trans_2.yaml","cnn_multi_band_config_agg_trans_2.yaml",
"cnn_multi_band_config_agg_trans_3.yaml","cnn_multi_band_config_agg_trans_3.yaml",
"cnn_multi_band_config_agg_trans_4.yaml","cnn_multi_band_config_agg_trans_4.yaml",
"cnn_multi_band_config_agg_trans_5.yaml","cnn_multi_band_config_agg_trans_5.yaml",
"cnn_multi_band_config_agg_trans_6.yaml","cnn_multi_band_config_agg_trans_6.yaml",
"cnn_multi_band_config_agg_trans_7.yaml","cnn_multi_band_config_agg_trans_7.yaml",
"cnn_multi_band_config_agg_trans_8.yaml","cnn_multi_band_config_agg_trans_8.yaml",
"cnn_multi_band_config_agg_trans_9.yaml","cnn_multi_band_config_agg_trans_9.yaml",
"cnn_multi_band_config_agg_trans_10.yaml","cnn_multi_band_config_agg_trans_10.yaml",
"cnn_multi_band_config_agg_trans_11.yaml","cnn_multi_band_config_agg_trans_11.yaml",
"cnn_multi_band_config_agg_trans_12.yaml","cnn_multi_band_config_agg_trans_12.yaml",
"cnn_multi_band_config_agg_trans_13.yaml","cnn_multi_band_config_agg_trans_13.yaml",
"cnn_multi_band_config_agg_trans_14.yaml","cnn_multi_band_config_agg_trans_14.yaml",
"cnn_multi_band_config_agg_trans_15.yaml","cnn_multi_band_config_agg_trans_15.yaml",
"cnn_multi_band_config_agg_trans_16.yaml","cnn_multi_band_config_agg_trans_16.yaml",
"cnn_multi_band_config_agg_trans_17.yaml","cnn_multi_band_config_agg_trans_17.yaml",
"cnn_multi_band_config_agg_trans_18.yaml","cnn_multi_band_config_agg_trans_18.yaml",
"cnn_multi_band_config_agg_trans_19.yaml","cnn_multi_band_config_agg_trans_19.yaml",
'''